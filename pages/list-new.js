    ...
    return (
        <div>
            ...
            <form action="/send-data-here" method="post" className={styles.form}>
                ...
                <input type="text" id="itemTitle" name="itemTitle" maxLength={255} className={styles.textInput}/>
                ...
                <input type="text" id="itemCost" name="itemCost" maxLength={31} className={styles.textInput}/>

                <label for="itemDescription"className={styles.label}>Description</label>
                <textarea type="text" id="itemDescription" name="itemDescription" maxLength={500} className={styles.textInput}/>

                <label for="itemContact"className={styles.label}>Name and Contact Info</label>
                <input type="text" id="itemContact" name="itemContact" maxLength={255} className={styles.textInput}/>
